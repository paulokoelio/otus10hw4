/**
\file
\brief Заголовочный файл с определениями шаблонных функций

Заголовочный файл с определением функций print_ip() для всех вариантов данных кроме 
tuple, а также с определением их вспомогательных функций.
*/
...
/**
Шаблонная вспомогательная внутренняя функция разделения значения интегрального типа 
по байтам
\param[in] data разбиваемое значение
*/
